...
crosstabulations. First, we use the data frame SData.
...
We then examine some additional crosstabulations based on the data frame TAData.
Note that Level in TAData denotes the transitions between SA levels.
